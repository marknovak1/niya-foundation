import { Building2, Users, GraduationCap, Puzzle } from "lucide-react";
          ...
          <div>
            <ul className="list-none">
              {[
                ...
                >
                  <div className="w-[42px] h-[42px] rounded-full bg-primary flex-shrink-0 flex items-center justify-center">
                    <item.icon size={24} strokeWidth={1.5} className="text-white" />
                  </div>
                  <div>
